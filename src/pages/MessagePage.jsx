...
const MessagePage = () => {
    ...
    return (
        <>
            ...
            <div
                ref={notesRef}
                className="w-full max-w-[400px] h-auto mx-auto overflow-y-auto overflow-x-hidden scrollbar-none"
            >
                ...
                {notesInView ? (
                            ...
                            <div className="min-w-[80px] flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    {notesInView ? (
                                        ...
                                        <div className="w-[60px] h-[60px] mt-2 mx-auto rounded-full bg-gray-200 animate-pulse" />
                    ...
                    <div className="w-[calc(100%-20px)] max-w-[380px] mx-auto h-32 bg-gray-200 animate-pulse rounded-lg mt-4" />
            ...
            <div
                ref={messageRef}
                className="w-full max-w-[400px] h-[500px] mx-auto overflow-y-auto scrollbar-none"
            >
                ...
                {messageInView ? (
                    ...
                    <div className="w-[calc(100%-20px)] max-w-[380px] mx-auto h-96 bg-gray-200 animate-pulse rounded-lg mt-4" />
