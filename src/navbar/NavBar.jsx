...
const NavBar = () => {
    ...
    return (
        <>
            {/* Top Header */}
            <div className='w-[400px] mx-auto h-[70px] bg-white '>
            ...
            {/* Bottom Navigation */}
            <div className="fixed bottom-0  w-[400px] h-[70px]  max-w-[380px] mx-auto bg-white border-t border-gray-200 z-50 left-[50%] translate-x-[-50%] ">
